...
import type { LanguageCode } from "../../utils/language_code/v1/language_code_pb";
import { file_spawner_utils_language_code_v1_language_code } from "../../utils/language_code/v1/language_code_pb";
...
export const file_spawner_main_v1_main: GenFile = /*@__PURE__*/
  fileDesc("", [file_google_protobuf_timestamp, file_spawner_packet_v1_packet, file_spawner_utils_error_v1_error, file_spawner_utils_language_code_v1_language_code]);
...
export type GenerateSessionTokenRequest = Message<"spawner.main.v1.GenerateSessionTokenRequest"> & {
  ...
  /**
   * @generated from field: spawner.utils.language_code.v1.LanguageCode language_code = 6;
   */
...
export type GenerateSessionTokenResponse = Message<"spawner.main.v1.GenerateSessionTokenResponse"> & {
  ...
  /**
   * @generated from field: spawner.utils.error.v1.ErrorEvent error = 6;
   */
  error?: ErrorEvent;
